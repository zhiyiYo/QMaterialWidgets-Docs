    ...
    <div class="dark-mode-feature-container">
        <div class="dark-mode-feature-card">
            ...
            <div class="iconContainer">
                <div class="lightIcon" style="background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/light-mode.3ff7dhv0p2i0.webp)"></div>
                <div class="darkIcon" style="background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/dark-mode.56i9pkm4gyc.webp);"></div>
            </div>
        ...
        <div class="dark-mode-view" ref="view" :style="`height: ${viewHeight}px`">
            ...
            <div :class="imgContainerClass">
                <img alt="" class="light-img" loading="lazy" decoding="async" src="https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/light-store.2b60f39zonpc.webp">
                <img alt="" class="dark-img" loading="lazy" decoding="async" src="https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/dark-store.5mr593wdx3w.webp">
            </div>
        </div>
    </div>
</template>
...
.dark-mode-view {
    ...
    .bg-img {
        ...
        background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/dark-mode-bg-light.45nh35nw2le0.webp);
...
.dark {
    ...
    .bg-img {
        background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/dark-mode-bg-dark.309wsx2xx900.webp);
    }
}
</style>