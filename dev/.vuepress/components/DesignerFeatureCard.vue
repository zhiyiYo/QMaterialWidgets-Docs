    ...
    <div class="designer-feature-container">
        <div class="designer-feature-card">
            ...
            <div class="iconContainer">
                <div class="lightIcon" style="background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/light-drag.7k5rxj0mkw00.webp)"></div>
                <div class="darkIcon" style="background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/dark-drag.2q34iiuupxs.webp);"></div>
            </div>
        ...
        <div class="designer-container">
            ...
            <div class="designer-wrapper" v-show="isDesignerSelected">
                <div class="designer-img-container">
                    <div class="designer-img-wrapper">
                        <img src="https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/login-designer.6jxpvaya1oo0.webp" alt="" decoding="async">
                    </div>
                </div>

                <!-- 代码块 -->
                <div class="code-card-container">
                    <CodeCard fileUrl="https://cdn.jsdelivr.net/gh/qmaterialwidgets/qmaterialwidgets.github.io@v0.0.1/dev/.vuepress/public/code/LoginWindow.ui" />
                </div>
            </div>
            ...
            <div class="designer-wrapper" v-show="!isDesignerSelected">
                <div class="designer-img-container">
                    <div class="designer-img-wrapper">
                        <img src="https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/components-login.5fipry3ydtk0.webp" alt="" decoding="async">
                    </div>
                </div>
...
.designer-container {
    ...
    .bg-img {
        ...
        background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/designer-bg-light.2ehqs25psedc.webp);
...
.dark {
    .bg-img {
        background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/designer-bg-dark.4h5pnousuzu0.webp);
    }
