<template>
    <div class="components-feature-container">
        <div class="components-feature-card">
            <!-- 图标 -->
            <div class="iconContainer">
                <div class="lightIcon" style="background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/light-components.5tktk04ppm40.webp)"></div>
                <div class="darkIcon" style="background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/dark-components.2sm0jis8vum0.webp);"></div>
            </div>

            <!-- 特性名称 -->
            <h2 class="name">{{ home.features.components.title }}</h2>

            <!-- 标题 -->
            <p class="title">{{ home.features.components.subTitle }}</p>

            <!-- 描述 -->
            <p class="content">{{ home.features.components.description }}</p>

            <!-- 了解更多按钮 -->
            <a class="more-btn" :href="home.features.components.url">{{ home.learnMore }}
            ...
            <div class="designer-wrapper">
                <div class="designer-img-container">
                    <div class="designer-img-wrapper">
                        <img src="https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/light-store.2b60f39zonpc.webp" alt="" decoding="async">
                    </div>
                </div>

                <!-- 代码块 -->
                <div class="code-card-container">
                    <CodeCard fileUrl="/code/store.py" />
                </div>
            </div>
        </div>
    </div>
...
.components-feature-card {
    ...
    .name {
        @apply mt-8 font-semibold text-indigo-500 py-0 mb-0 before:contents text-base;
    }
...
.components-view {
    ...
    .bg-img {
        ...
        background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/components-bg-light.2vbsflt3uri0.webp);
    ...
    .designer-wrapper {
        ...
        .designer-img-container {
            ...
            .designer-img-wrapper {
                @apply relative z-10 rounded-xl bg-white shadow-xl ring-1 ring-slate-900/5 overflow-hidden my-auto xl:mt-[3.7rem] dark:bg-slate-800;
...
.dark {
    .bg-img {
        background-image: url(https://cdn.staticaly.com/gh/qmaterialwidgets/picx-images-hosting@master/20230824/components-bg-dark.z81asyt904w.webp);
    }
